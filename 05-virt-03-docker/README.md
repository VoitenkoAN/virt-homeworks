...
![Снимок экрана от 2023-02-01 16-05-53](https://user-images.githubusercontent.com/110226611/215999528-1be9d2f6-349a-434b-a2cf-0552c669356d.png)


- Запустите второй контейнер из образа ***debian*** в фоновом режиме, подключив папку ```/data``` из текущей рабочей директории на хостовой машине в ```/data``` контейнера;

![Снимок экрана от 2023-02-01 16-09-36](https://user-images.githubusercontent.com/110226611/216000027-412bdf01-5843-41f7-bcf2-e2de218ea509.png)

![Снимок экрана от 2023-02-01 16-39-17](https://user-images.githubusercontent.com/110226611/216006697-0b55931f-57a5-4376-98aa-4d31159ece16.png)


- Подключитесь к первому контейнеру с помощью ```docker exec``` и создайте текстовый файл любого содержания в ```/data```;


![Снимок экрана от 2023-02-01 16-42-36](https://user-images.githubusercontent.com/110226611/216007746-89feae34-c303-4cd3-baea-6766ef58670f.png)

- Добавьте еще один файл в папку ```/data``` на хостовой машине;

![Снимок экрана от 2023-02-01 16-45-20](https://user-images.githubusercontent.com/110226611/216008167-fa91f8fb-d060-4dcd-8799-8fd1366e40fd.png)
...
![Снимок экрана от 2023-02-01 16-48-19](https://user-images.githubusercontent.com/110226611/216008886-3d3576af-92d7-49b9-a6ca-470641677bb6.png)
